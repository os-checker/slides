...
<span class="bold"><span class="f1"><span class="bold">error</span></span></span>: <span class="bold">Tags are not discharged: `ValidBaseAddr`, `OwnedResource`</span>
 <span class="bold"><span class="f4"><span class="bold">--&gt;</span></span></span> ./tests/snippets/fault_event_err.rs:8:14
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>
<span class="bold"><span class="f4"><span class="bold">8 |</span></span></span>     unsafe { FaultEventRegisters::new(base_register_vaddr) }
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>              <span class="bold"><span class="f1"><span class="bold">^^^^^^^^^^^^^^^^^^^^^^^^</span></span></span> <span class="bold"><span class="f1"><span class="bold">For this unsafe call.</span></span></span>
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>
  <span class="bold"><span class="f4"><span class="bold">= info</span></span></span>: `ValidBaseAddr(addr, hardware)`: `{addr}` must be a valid base address of {hardware}.
  <span class="bold"><span class="f4"><span class="bold">= info</span></span></span>: `OwnedResource(value, owner)`: `{value}` must be exclusively owned by {owner}.
</pre>
    </div>
</template>
